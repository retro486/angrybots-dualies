...
class CameraControl extends MonoBehaviour {
	...
	public var m_RightStickPosition : Vector2;
...
//				
//			// Right stick update
//			m_RightStickPosition.x = Input.GetAxis("RightHorizontal");
//			m_RightStickPosition.y = Input.GetAxis("RightVertical");
//			
//			if(m_RightStickPosition.sqrMagnitude > 0)
//				m_RightStickPosition.Normalize();
